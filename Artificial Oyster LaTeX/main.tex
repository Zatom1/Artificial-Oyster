...
\begin{document}
	...
	\begin{figure}[h]
		...
		\caption[FiJi Particle Counting]{An example of how the FiJi image analysis software counts particles. Here, a 28x28 mm square is shown, with particles identified by FiJi circled in yellow.}
		\label{fig:FiJiAnal}
	\end{figure}
