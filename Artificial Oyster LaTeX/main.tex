...
\begin{document}
	...
	\begin{enumerate}
		...
		\end{enumerate}
			...
			\caption[Device Deployment]{This image shows the author deploying the device. The ropes attached to the device's ends allow it to be manipulated in the manner of a marionette puppet, giving control of position and pitch.}
